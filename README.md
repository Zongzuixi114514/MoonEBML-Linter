...
decoding, element-header reading, zero-copy payload views, and a bounded
element walker. Higher layers will be added one feature at a time after each
increment has a passing test suite.
